 ...
 * @author th
 */
public class MonitorController2 extends BaseClientController<ServerTabController> implements Initializable {
    private static final Logger log = LoggerFactory.getLogger(MonitorController2.class);
