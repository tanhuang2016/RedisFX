...
import redisfx.tanh.rdm.common.Constant;
import redisfx.tanh.rdm.common.util.FileUtil;
import redisfx.tanh.rdm.ui.Main;
import redisfx.tanh.rdm.ui.common.UiStyles;
...
import redisfx.tanh.rdm.ui.handler.convert.ValueConverter;
import redisfx.tanh.rdm.ui.handler.convert.ValueConverters;
import redisfx.tanh.rdm.ui.handler.view.CharacterEncoding;
import redisfx.tanh.rdm.ui.handler.view.ValueViewer;
import redisfx.tanh.rdm.ui.handler.view.ValueViewers;
import redisfx.tanh.rdm.ui.handler.view.ViewerNode;
...
//        stage.show();
    ...
    public void export(ActionEvent actionEvent) {
        ...
        File file = GuiUtil.saveFileChoose(this.root.getScene().getWindow(), lastFile, parentController.getParameter().getKey().replaceAll(":","_"));
        if(file==null){
            return;
        }
